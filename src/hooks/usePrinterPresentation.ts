 ...
 * a real printer is connected, and whether to offer a Connect or Disconnect action. The header
...
export function usePrinterPresentation() {
  ...
  return {
    ...
    isWebUsb,
    connected,
    showConnect: isWebUsb && !connected,
    showDisconnect: isWebUsb && connected,
  };
}
